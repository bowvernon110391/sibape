  ...
  <div>
    <b-card no-body class="rounded shadow">
      ...
      <b-card-header>
        ...
        <h4 :class="[ 'd-inline-block', 'bg-primary', 'my-auto', 'text-light', 'p-2', 'shadow', 'border', 'border-dark', 'rounded']">CD #2331 <b-badge variant="light"><font-awesome-icon icon="lock-open"></font-awesome-icon> OPEN</b-badge></h4>
        <!-- buttons? -->
      ...
      <b-tabs card>
        ...
        <b-tab title="Data">
          <!-- <b-card-text> -->
            <div v-if="excelData">
              <h5>Parsed Data</h5>
              <b-table responsive small hover head-variant="dark" bordered striped :items="excelData" class="rounded shadow"></b-table>
            </div>
            <div v-else class="text-center">
              <b-alert variant="danger" title="No Data" show>
                No data loaded. Might wanna try parse some excel from the form tab?
              </b-alert>
            </div>
          <!-- </b-card-text> -->
        </b-tab>
